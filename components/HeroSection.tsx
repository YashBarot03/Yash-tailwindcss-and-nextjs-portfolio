        ...
        <div className="md:mt-2 md:w-3/5">
          <div className="fontsfamily">
            ...
            <h1 className="text-4xl  font-bold mt-6 md:mt-0 md:text-7xl">Hi, I&#39;m
              <div className="text-teal-500">Yash Barot
            ...
            <div className="text-md mt-4 mb-6 md:text-2xl">
              <p className="animated-text-1 ">I&#39;m a{" "}
                ...
                </span> & <span className="font-medium text-teal-500">Data Analyst.</span>
              </p>

              <p id="animated-text-2">I have compeleted my Engineering.</p>
              <p id="animated-text-3"> Enhancing my Full stack as well as Data Analysis Skills.</p>
            </div>
          </div>
