      ...
      <div className="  ">
        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
          <div className="md:w-1/2 ">
            ...
            <p>
              Hi, my name is <span className="font-bold text-teal-500">Yash Barot </span>and I am a{" "}
              <span className="font-bold">{"highly ambitious"}</span>,
              <span className="font-bold">{" self-motivated"}</span>, and
              <span className="font-bold">{" driven"}</span> Full Stack Developer & Data Analyst.
            </p>
            <br />
            <p>
             🧑‍🎓 I have compeleted my Bachelor&#39;s of Engineering in Electronics & Telecommunication.<br></br>
             📚 I am exploring emerging technologies at the moment.<br></br>
              💻 I am gaining further insight into full-stack development expertise. <br></br>
